...
AI SDK 附带多个提供商，您可以使用它们与不同的语言模型进行交互：

<OfficialModelCards />

还有一些使用[语言模型规范](./community-providers/custom-providers)创建的[社区提供商](./community-providers)。

<CommunityModelCards />

## 提供商支持

并非所有提供商都支持所有 AI SDK 功能。以下是热门模型能力的快速比较：
