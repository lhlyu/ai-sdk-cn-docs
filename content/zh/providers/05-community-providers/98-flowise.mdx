...
**[Flowise 提供商](https://github.com/ahmedrowaihi/flowise-ai-sdk-provider)** 允许你通过 AI SDK 轻松将 [Flowise](https://flowiseai.com/) 聊天流集成到你的应用程序中。

## 安装

Flowise 提供商位于 `@ahmedrowaihi/flowise-vercel-ai-sdk-provider` 模块中。你可以通过以下方式安装：
...
你可以从 `@ahmedrowaihi/flowise-vercel-ai-sdk-provider` 导入提供商工厂函数：
