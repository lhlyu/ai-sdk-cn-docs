...
[AI SDK Core](/docs/ai-sdk-core) 是一组函数，允许你与语言模型及其他 AI 模型进行交互。
这些函数设计得易于使用且灵活，支持从语言模型和其他 AI 模型生成文本、结构化数据以及嵌入。
...
<IndexCards
  cards={[
    ...
    },
    {
      ...
      description: '从生成的文本中提取推理，并将其作为结果的 `reasoning` 属性暴露。',
