...
<IndexCards
  cards={[
    ...
    {
      title: 'Output',
      description: 'generateText 和 streamText 的结构化输出类型。',
...
<IndexCards
  cards={[
    ...
    },
    {
      ...
      description: '将未知值验证为 MCP JSON-RPC 消息。',
      href: '/docs/reference/ai-sdk-core/validate-json-rpc-message',
    },
    {
      title: 'MCP Apps',
      description: '用于渲染交互式 MCP 工具 UI 和过滤应用可见工具的辅助工具。',
    ...
    },
    {
      ...
      description: '创建一个 ReadableStream，以可配置的延迟发出值。',
