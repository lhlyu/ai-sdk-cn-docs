...
你可以使用 `providerOptions` 参数设置模型特定的设置。
...
- `responses`：关于语音模型响应的元数据，包括时间戳、模型和请求头。
...
以上仅是 AI SDK 提供商所支持的语音模型中的一小部分。更多信息，请参阅相应提供商的文档。
