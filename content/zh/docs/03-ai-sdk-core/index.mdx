  ...
  cards={[
    {
      title: '概述',
      description:
        '了解 AI SDK Core 以及如何与大语言模型（LLM）协同工作。',
    ...
    },
    {
      title: '运行时与工具上下文',
      description:
        '了解如何在生成和智能体之间传递共享运行时状态及每个工具的上下文。',
    ...
    },
    {
      title: '推理',
      description:
        '了解如何通过顶层推理参数控制不同提供商的推理过程。',
      href: '/docs/ai-sdk-core/reasoning',
    },
    {
      title: '嵌入',
      description: '了解如何在 AI SDK Core 中使用嵌入。',
    ...
    {
      title: '文件上传',
      description: '了解如何使用 AI SDK 向提供商上传文件。',
    ...
    {
      title: '中间件',
      description: '了解如何在 AI SDK Core 中使用中间件。',
    ...
    {
      title: '遥测',
      description: '了解如何在 AI SDK Core 中使用遥测。',
